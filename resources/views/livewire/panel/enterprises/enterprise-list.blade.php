<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full mt-8">
        ...
        <div class="w-full mb-4 text-right">
            <a class="bg-main-blue text-white px-4 py-2 rounded-lg hover:shadow-lg hover:bg-main-blue-hover" href="{{ route('panel.enterprise.create') }}">Novo</a>
        </div>
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach ($enterprises as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('panel.enterprise.details', $item->id) }}" class="text-main-dark mr-4">Informações</a>
                            <a href="{{ route('panel.enterprise.imagens', $item->id) }}" class="text-main-dark mr-4">Imagens</a>
                            <a href="{{ route('panel.enterprise.edit', $item->id) }}" class="text-main-yellow mr-4">Editar</a>
