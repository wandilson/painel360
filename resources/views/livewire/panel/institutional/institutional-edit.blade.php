<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full mt-8">
        ...
        <div class="w-full mb-4 text-right">
            <a class="bg-gray-50 text-main-dark px-4 py-2 rounded-lg hover:shadow-lg" href="{{ route('panel.institutional') }}">Voltar</a>
        </div>
        ...
        <div class="bg-white p-4">
            <form wire:submit.prevent="update">
                ...
                <div class="w-full mt-10">
                    <label class="block text-sm text-gray-600" for="title">Link vídeo youtube:</label>
                    <input wire:model="link_video" class="w-full px-5 py-3 text-gray-700 bg-gray-200 rounded border-gray-200 font-semibold" type="text">
                    @error('link_video')
                        <small class="text-red-500">{{ $message }}</small>
                    @enderror
                </div>
                ...
                --> 
                <div class="w-full mt-10">
                    <label class="block text-sm text-gray-600" for="description">Texto:</label>
                    <textarea wire:model="description" name="" cols="30" rows="10" width="100%" class="w-full px-5 py-3 text-gray-700 bg-gray-200 rounded border-gray-200 font-semibold"></textarea>
                    @error('description')
                        <small class="text-red-500">{{ $message }}</small>
                    @enderror
                </div>
